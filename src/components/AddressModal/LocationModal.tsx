...
const LocationModal = observer(({ onClose, onCitySelect }: { onClose: any; onCitySelect: any }) => {
    const { city, userAddresses, selectedAddress, selectAddress, addNewAddress } = locationStore;
