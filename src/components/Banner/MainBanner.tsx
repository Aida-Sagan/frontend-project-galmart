...
import { fetchHomepageBanners } from '../../endpoint-service/services/bannerService';

import './style/MainBanner.css';

const MainBanner = ({ banners: initialBanners }: { banners?: any[] } = {}): any => {
    ...
    const imageSrc = currentBanner?.images.null?.image|| '';
