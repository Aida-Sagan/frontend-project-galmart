...
const CartItem = ({ item, isPromo, isOutOfStock }) => {
    ...
    return (
        <div className={`cart-item ${isOutOfStock ? 'out-of-stock' : ''} ${isPromo ? 'promo' : ''}`}>
            ...
            >
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M5.18581 5.18919C5.42989 4.94511 5.82561 4.94511 6.06969 5.18919L9.99662 9.11612L13.9235 5.18919C14.1676 4.94511 14.5633 4.94511 14.8074 5.18919C15.0515 5.43327 15.0515 5.829 14.8074 6.07307L10.8805 10L14.8074 13.9269C15.0515 14.171 15.0515 14.5667 14.8074 14.8108C14.5633 15.0549 14.1676 15.0549 13.9235 14.8108L9.99662 10.8839L6.06969 14.8108C5.82561 15.0549 5.42989 15.0549 5.18581 14.8108C4.94173 14.5667 4.94173 14.171 5.18581 13.9269L9.11273 10L5.18581 6.07307C4.94173 5.829 4.94173 5.43327 5.18581 5.18919Z" fill="#7A7A7A"/>
                </svg>
