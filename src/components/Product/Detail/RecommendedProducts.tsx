...
const RecommendedProductCard = ({ item, currentSectionId }: { item: any; currentSectionId?: any }) => {
...
const RecommendedProducts = ({ items, currentSectionId }: { items: any; currentSectionId?: any }) => {
