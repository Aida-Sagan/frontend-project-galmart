...
import { setPromocode, attachNewCard } from '../../endpoint-service/services/cartService';
...
import { InputText, Button, Checkbox } from '../../components/ui';
...
const CartContent = observer((): any => {
    const {
        cartData,
        isLoading,
        items,
    ...
    const { city, isLoading: isLocationLoading, selectedAddress } = locationStore;
                ...
                <div className="cart-checkout-column">
                    ...
                    <div className="checkout-widget clickable-widget">
                        ...
                        <div className="widget-input-wrapper">
                            <InputText
                                ...
                                onChange={(val) => setCheckoutDetails({...checkoutDetails, comment: val})}
                    ...
                    <div className="checkout-widget summary-widget">
                        ...
                        <Checkbox
                            ...
                            onChange={(val) => setCheckoutDetails({...checkoutDetails, acceptPriceChanges: val})}
                            label={<span className="legal-text-cart">{checkboxMessage}</span>}
                        />
                        <Button variant="filled" fullWidth disabled={!isCheckoutReady} onClick={handleOrderSubmit}>Оплатить {finalTotal.toLocaleString()} {currency}</Button>
                    </div>
                </div>
            </div>
            <OrderSuccessModal
