...
import ArrowUpIcon from '../../components/CustomIcons/ArrowUpIcon';
...
const FavoriteSortDropdown = ({ sortOption, setSortOption }: { sortOption: string; setSortOption: (v: string) => void }) => {
