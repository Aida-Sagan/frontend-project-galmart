...
import CustomDropdown from './CustomActionDropdown';
import { registerCheck } from '../../../endpoint-service/services/profileService';
            ...
            <form onSubmit={handleRegistrationSubmit} className="check-registration-form-wrapper">
                ...
                <section className="form-section">
                    ...
                    <div className="form-group floating-label">
                        ...
                        >
                            {/* @ts-ignore - react-input-mask render prop type mismatch */}
                            {(inputProps: any) => (
                                <input
                                    {...inputProps}
                                    type="tel"
                ...
                <Button type="submit" variant="filled" fullWidth disabled={isSubmitting}>Зарегистрировать чек</Button>
            </form>
