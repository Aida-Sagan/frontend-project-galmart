...
import { deleteAddress } from '../../../endpoint-service/services/addressService';
                ...
                <div className="delete-modal-content">
                    ...
                    <div className="address-delete-modal">
                        ...
                        <div className="modal-actions">
                            <Button variant="outlined" fullWidth onClick={handleCancelDelete} disabled={isDeleting}>
                                Нет
                            </Button>
                            <Button variant="filled" fullWidth onClick={handleConfirmDelete} disabled={isDeleting}>
