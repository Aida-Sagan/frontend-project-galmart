                ...
                {purchases.map(purchase => (
                    <div key={purchase.id} className="purchase-card" onClick={() => handleDetailClick(purchase)}>
                        ...
                        <div className="card-right">
                            <span className="purchase-total-amount">{purchase.total.toLocaleString()} {purchase.currency || '₸'}</span>
                            <span className="purchase-bonuses-amount">Бонусы: {purchase.bonuses.toLocaleString() || 0} {purchase.currency || '₸'}</span>
