...
import { deleteSavedCard, attachNewCard } from '../../../endpoint-service/services/cartService';
        ...
        <div className="modal-overlay">
            <div className="modal-content">
                ...
                <div className="logout-modal-actions">
                    <Button variant="filled" fullWidth onClick={onConfirm}>Да, удалить карту</Button>
                    <Button variant="outlined" fullWidth onClick={onCancel}>Нет</Button>
                </div>
            </div>
        </div>
    );
...
const PaymentMethodsList = ({ cardsData, isLoading, refreshCards }: any) => {
