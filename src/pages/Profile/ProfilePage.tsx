...
import OfflinePurchasesList from './Offline/OfflinePurchasesList';
import MyAddresses from './MyAdresses/MyAddresses';
import CheckRegistrationForm from './CheckRegistration/CheckRegistrationForm';
...
import OnlineOrdersList from './Online/OnlineOrdersList';
                ...
                <div className="modal-overlay" onClick={() => setIsLogoutModalOpen(false)}>
                    <div className="logout-modal-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="logout-modal-actions">
                            <Button variant="filled" fullWidth onClick={handleLogout}>Выйти</Button>
                            <Button variant="outlined" fullWidth onClick={() => setIsLogoutModalOpen(false)}>Не выходить</Button>
                        </div>
                    </div>
                </div>
            )}
